  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-stone-500 mt-2 max-w-xs">Танд одоогоор сонгосон жимс алга байна. Манай шинэ ургацын жимснүүдээс сонирхоорой.</p>
  ...
  return (
    ...
    <div className="flex-grow w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="flex items-center gap-2 mb-8 group cursor-pointer">
        <Link href="/" className="flex items-center gap-2 text-stone-500 hover:text-slate-900 transition-colors">
            <ArrowLeft size={18} className="group-hover:-translate-x-1 transition-transform" />
            <span className="text-sm font-medium">Үргэлжлүүлэн худалдан авалт хийх</span>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 xl:col-span-8">
          <div className="flex items-baseline justify-between mb-8 border-b border-stone-100 pb-4">
            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Миний сагс</h2>
            <span className="text-stone-400 font-medium">{cartItems.length} нэр төрөл</span>
          </div>
        ...
        <div className="lg:col-span-5 xl:col-span-4">
          <div className="sticky top-28 bg-white border border-stone-200 shadow-sm rounded-[2rem] p-8">
            <h3 className="text-xl font-bold text-slate-900 mb-6">Захиалгын мэдээлэл</h3>
            ...
            <div className="space-y-4 mb-8">
              ...
              {deliveryFee > 0 && (
                <p className="text-[11px] bg-green-50 text-green-700 p-2 rounded-lg">
                  💡 <b>{ (50000 - subtotal).toLocaleString() }₮</b>-ийн худалдан авалт нэмээд <b>Үнэгүй хүргүүлээрэй!</b>
                </p>
              )}
            </div>
            ...
            <div className="pt-6 border-t border-stone-100 mb-8">
              <div className="flex justify-between items-center">
                <span className="text-slate-500 font-medium">Нийт төлөх дүн</span>
