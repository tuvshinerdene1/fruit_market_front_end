        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-10">
            <div>
              ...
              <p className="text-slate-600 mt-2">Гэр бүл, найз нөхөддөө өгөх хамгийн шилдэг бэлэг</p>
            </div>
            <Link 
              href="/bundle" 
          ...
          <div className="mt-8 md:hidden">
            <Link href="/bundle" className="block text-center bg-white border border-green-200 py-3 rounded-xl font-bold text-green-700">
              Бүх багцыг үзэх
            </Link>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="flex justify-between items-end mb-10">
          <div>
            ...
            <p className="text-slate-600 mt-2">Өнөөдөр ирсэн шинэхэн жимснүүд</p>
          </div>
          <Link 
            href="/fruit" 
        ...
        {/* Mobile View All Button */}
        <div className="mt-8 md:hidden">
          <Link href="/fruit" className="block text-center bg-slate-100 py-3 rounded-xl font-bold text-slate-700">
            Бүх жимсийг үзэх
          </Link>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4">
        <div className="bg-slate-900 rounded-[2rem] p-8 md:p-16 flex flex-col md:flex-row items-center justify-between overflow-hidden relative">
           <div className="relative z-10 text-center md:text-left">
              <h2 className="text-white text-3xl md:text-5xl font-black mb-4">24 цагийн дотор <br/> таны хаалган дээр.</h2>
              <p className="text-slate-400 text-lg mb-8">Улаанбаатар хот доторх хамгийн хурдан хүргэлт.</p>
